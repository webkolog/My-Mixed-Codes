...
namespace _06_PrintingGiris
{
    public partial class Form3 : Form
    {
        ...
        {
            //printDocument1.DefaultPageSettings.PaperSize.Width = 500;
            //printDocument1.DefaultPageSettings.PaperSize.Width = 800;
            //printDocument1.PrinterSettings.DefaultPageSettings.PaperSize.Height = 500;
            YazimYuksekligi = 0;
            ...
            Yazdir(gr, "Kadıkoy Vergi Dai. 1234564", "Arial", 13f, FontStyle.Regular, 10, YazimYuksekligi, true);

            SizeF YaziB = gr.MeasureString("Sogutlu cesme mah no: 45", new Font("Arial", 10f, FontStyle.Regular));
            float YaziGEnislik = YaziB.Width;
            float PnlGenislik = Convert.ToSingle(e.PageBounds.Width);
        ...
        {
            //printDocument1.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("Custom", 300, 500);
        ...
        {
            printDocument1.DefaultPageSettings.PaperSize = new System.Drawing.Printing.PaperSize("Fiş Sayfası", 300, 500);
        }
    }
}
